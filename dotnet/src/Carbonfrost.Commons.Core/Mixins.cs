    ...
    static class Mixins {
        ...
        public static IEnumerable<TypeInfo> GetTypesHelper(this Assembly a) {
            ...
            try {
                ...
                return e.Types.WhereNotNull().Select(t => t.GetTypeInfo());
            }
        }

        public static void AddMany<T>(this ICollection<T> self,
                                      IEnumerable<T> items) {
        ...
        public static char? RequireNext(this IEnumerator<char> e) {
            if (e.MoveNext()) {
                return e.Current;
            }
            return null;
