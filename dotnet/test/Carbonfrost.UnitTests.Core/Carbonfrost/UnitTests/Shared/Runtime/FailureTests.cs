...
namespace Carbonfrost.UnitTests.Core {
    ...
    public class FailureTests {
        ...
        [Fact]
        public void NotEnoughSpaceInArray_parity_with_array_copy() {
            ...
            Assert.IsInstanceOf(arrayException.GetType(),
                Failure.NotEnoughSpaceInArray("argumentName", EMPTY_ARRAY));
        }
    }
}
